...
export const VibrationTimeQuarterM = ({ consultant, newDate }) => {
  const listOfMonths = consultant.getCustomMonths()
  const listOfMonthsE = consultant.getCustomMonths(consultant.getAllMonthsEnglish())
...
ism4 = false
  ...
  const indexE = listOfMonthsE.findIndex(i => i === 'January')
  const currentMonthE = listOfMonthsE.findIndex(i => i === capitalize(actualMonth))
