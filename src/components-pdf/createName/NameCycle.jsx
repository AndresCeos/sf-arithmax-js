...
export const ActiveName = ({ table, start, consultant, nameCycles, date, position }) => {
    ...
    <View style={pinnacleName.container}>
      <View style={pinnacleName.wrap}>
        <View style={[pinnacleName.table, { top: 355, left: -230 + (position * 88) }]}>
          ...
          <View style={{ width: 40, height: 36, backgroundColor: '#0000002d', display: 'flex', justifyContent: 'center' }}>
          ...
          {table.map((el, i) => (
            <View key={i} style={{ position: 'absolute', left: 40 + (i * 20), top: 0 }}>
              ...
              <View style={{ width: 20, height: 36, backgroundColor: `${bkConfig(i + start, '#0000002d')}`, display: 'flex', justifyContent: 'center' }}>
                ...
                <View style={{ height: 17, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
