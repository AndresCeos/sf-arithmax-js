...
export const GroupPinacle3 = ({groupConsultant}) =>{
  ...
  return(
    ...
    {cap[5] !== undefined?<View style={[style.wrap, style.wrap1]}>
    ...
    {cap[6] !== undefined?<View style={[style.wrap, style.wrap2]}>
    ...
    {cap[7] !== undefined?<View style={[style.wrap, style.wrap3]}>
