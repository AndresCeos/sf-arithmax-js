    ...
    <View style={timeCurve.container}>
      <View style={timeCurve.wrap}>
        ...
        <View style={[timeCurve.circle, timeCurve.s1_vibration]}>
          <Text>{groupConsult.calcLifeStage(1)}{groupConsult.calcLifeStageISK(1)}</Text>
        </View>
        <View style={[timeCurve.circle, timeCurve.s2_vibration]}>
          <Text>{groupConsult.calcLifeStage(2)}{groupConsult.calcLifeStageISK(2)}</Text>
        </View>
        <View style={[timeCurve.circle, timeCurve.s3_vibration]}>
          <Text>{groupConsult.calcLifeStage(3)}{groupConsult.calcLifeStageISK(3)}</Text>
        </View>
        <View style={[timeCurve.circle, timeCurve.s4_vibration]}>
          <Text>{groupConsult.calcLifeStage(4)}{groupConsult.calcLifeStageISK(4)}</Text>
        </View>
