  ...
  return(
    <View style={data.container}>
        <View style={data.partners}>
          <Text style={[data.textName,{top:20}]}>{consultant.fullNameView}</Text>
          <Text style={[data.textBirth,{top:20}]}>{consultant.getFormBirthDate()}</Text>
          <Text style={[data.textAge,{top:20}]}>{consultant.getYearsOld(newDate.year())}</Text>
        </View>
        <View style={data.partners}>
