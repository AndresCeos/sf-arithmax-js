...
export const SynastryNineCycle = ({ synastry, newDate }) => {
...
return (
  <View style={cycle.container}>
    <View style={[cycle.cyleMap, { width: '80px' }]}>
      <Text style={[cycle.text, { top: 25, left: 130, width: '50px' }]}>Etapa: {synastry.getLifeStageNumber(currentYear)}:  </Text>
      <Text style={[cycle.number, { top: 23, left: 175, width: '30px' }]}>{synastry.getLifeStage(currentYear)}{synastry.getLifeStageISK(currentYear)}</Text>
    </View>
