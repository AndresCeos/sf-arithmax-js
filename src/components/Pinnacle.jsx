...
export const Pinnacle = ({ consultant, size }) => {
  return(
    <div id="pinaculo" className={`relative ${size !== undefined ? size : ''}`}>
      ...
      <div id='pinaculo-letters' className="relative w-full left-0 right-0 mx-auto" >
        ...
        <div className="pinncle-letter" border="purple" appearance="purple-30" data-letter="D">{consultant.getD()}{consultant.getDISK()}</div>
        ...
        <div className="pinncle-letter" border="green" appearance="green" data-letter="H">{consultant.getH()}{consultant.getHISK()}</div>
