...
export const Sidebar = () => {
  ...
  return(
    <div id='App-Sidebar' className="flex flex-col justify-between shrink-0 text-gray-500">
      <div className='sidebar-top'>
        <div className="mt-3 flex py-2 px-3">
          <img src={photoURL} className="profile-pic rounded-full" alt='profile' />
          ...
          <ul className="flex flex-col flex-wrap pl-0 mt-0 list-none text-sm">
            <li className="">
              <NavLink
                ...
                className="sidebar-link text-13 pl-3 pr-1 py-2 flex items-center border-b border-separator"
                aria-current="page"
            ...
            <li className="">
              <button
                ...
                aria-current="page"
                onClick={() => setItemActive('personal')}
              >
            ...
            <li className='config-menu'>
              <NavLink
                ...
                to="/config"
                // activeClassName='is-active-purple'
            ...
            <li className='config-menu'>
              ...
              >
                <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M3.72803 4.37557C3.83395 1.01222 7.1808 -0.228105 7.94331 4.37557H3.72803ZM9.36241 4.37557C8.66337 -1.32103 3.00783 -1.59441 2.24532 4.37557H0.656644L0 15.979L11.6078 16L10.93 4.37541L9.36241 4.37557Z" fill="black" fillOpacity="0.35"/>
                </svg>
        ...
        <ul className="flex flex-col flex-wrap pl-0 mt-0 list-none">
          ...
          <li className="my-1">
            <NavLink
              ...
              to="/" className="sidebar-link text-13"
              aria-current="page">
              Manual de Usuario
            </NavLink>
          </li>
