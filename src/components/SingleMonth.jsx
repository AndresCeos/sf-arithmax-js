      ...
      <div className='col-start-2 col-end-8'>
        ...
        <div className=' grid grid-cols-7 '>
          {daysInMonthSingle.map((day,index)=>
            ...
            ${(day === moment().date()&&singleMonth===currentMonthNumber+1&&newDate.year()===moment().year())?'bg-yellow':(newDate.year()===moment().year()&&singleMonth===currentMonthNumber+1&& (sem1&&day>=1&&day<=7||sem2&&day>=8&&day<=14||sem3&&day>=15&&day<=21||sem4&&day>=22))?'bg-gold-week':(day%2==0)? 'bg-gray-10':''}
      ...
      <div className='col-start-2 col-end-8'>
        ...
        <div className=' grid grid-cols-7 '>
          {daysInMonth.map((day,index)=>
            <div key={index} className={`
              ${(day ===moment().date()&&month===currentMonthNumber+1&&newDate.year()===moment().year())?'bg-yellow text-white font-bold':(newDate.year()===moment().year()&&month===currentMonthNumber+1&&(sem1&&day>=1&&day<=7||sem2&&day>=8&&day<=14||sem3&&day>=15&&day<=21||sem4&&day>=22))?'bg-gold-week':(newDate.year() === moment().year()&&month===currentMonthNumber+1&&single===false)?' bg-gold-10 text-gray-500 ':'text-gray-500'}
              ${single?'h-16':'h-12'}
