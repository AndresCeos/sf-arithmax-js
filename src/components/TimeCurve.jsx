            ...
            <div id="lifePath" className="grid grid-cols-19 w-full border-l border-b border-gray-400 relative">
                ...
                <svg width="1057" height="193" viewBox="0 0 1057 193" fill="none" xmlns="http://www.w3.org/2000/svg" className='absolute bottom-0 left-0 w-full'>
                    <g filter="url(#filter0_i_73_2520)">
                        <path d="M1 182.875C1 182.875 188.888 187.042 331.294 147.308C523.668 101.113 537.259 -109.373 766.947 79.1422C835 134.996 969.409 185.983 1056 191" stroke="url(#paint0_linear_73_2520)" strokeWidth="4" stroke-miterlimit="10"/>
                    </g>
                    <defs>
                        <filter id="filter0_i_73_2520" x="0.957764" y="-4.00026" width="1055.16" height="196.997" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        ...
                        <linearGradient id="paint0_linear_73_2520" x1="509" y1="2" x2="509" y2="183" gradientUnits="userSpaceOnUse">
                            <stop stop-color="#008C60"/>
                            <stop offset="1" stop-color="#EEF9D9"/>
                        </linearGradient>
                    </defs>
                </svg>
