...
export const UpdateButton = () => {
  ...
  return (
    <div className={`transition transform fixed z-100 bottom-0 inset-x-0 pb-2 sm:pb-5 opacity-100 scale-100 translate-y-0 ease-out duration-500 ${isVisible || 'hidden'}`}>
            ...
            <div className="w-0 flex-1 flex items-center">
              <p className="ml-3 font-medium text-white truncate">
                <span className="hidden lg:inline text-gray-400">
                  <strong className="text-white font-semibold mr-1">Actualización disponible!</strong>
                </span>
              </p>
            </div>
