    ...
    <div className='grid grid-cols-12 mt-8 mx-14 gap-6 pt-10'>
      ...
      <div className='col-span-12 mb-5'>
        ...
        <div className='pinnacle-wrap px-8 py-8'>
          ...
          <ActiveName table={table1} start={0} consultant={consultant} nameCycles={nameCycles} nameSubCycles={nameSubCycles} />
          <ActiveName table={table2} start={31} consultant={consultant} nameCycles={nameCycles} nameSubCycles={nameSubCycles} />
          <ActiveName table={table3} start={62} consultant={consultant} nameCycles={nameCycles} nameSubCycles={nameSubCycles} />
          <ActiveName table={table4} start={93} consultant={consultant} nameCycles={nameCycles} nameSubCycles={nameSubCycles} />
