      ...
      {(isSelectPartner)?
        <div className='col-span-12'>
          ...
          <div className='pinnacle-wrap grid grid-cols-3 p-1'>
            ...
            <div className="bg-white p-4 border-gray-400 border-r border-l">
              <AnnualReturn
            ...
            <div className="bg-white p-4 border-gray-400 border-t border-b">
              <AnnualReturn
            ...
            <div className="bg-active-radial p-4 border-gray-400 border">
              <AnnualReturn
                current={true}
