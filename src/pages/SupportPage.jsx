      ...
      <div className='col-span-7 mb-1 row-start-2 '>
          ...
          <div className='pinnacle-wrap px-5 py-4  '>
            <div className="flex justify-between items-center">
              <a href="https://app.numerologia-cotidiana.com/formulario-de-soporte-arithmax/" target="_blank" className="px-6 py-2 btn-yellow rounded-full text-m">Enviar Solicitud</a>
              <a href="https://app.numerologia-cotidiana.com/glosario-de-numerologia/" target="_blank" className="px-6 py-2 btn-blue rounded-full text-m">Centro de ayuda</a>
              <a href="https://app.numerologia-cotidiana.com/glosario-de-numerologia/" target="_blank" className="px-6 py-2 btn-green rounded-full text-m">Glosario</a>
            </div>
          </div>
      </div>
